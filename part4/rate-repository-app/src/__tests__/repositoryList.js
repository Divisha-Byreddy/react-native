...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        expect(getAllByTestId('forksCount')[0]).toHaveTextContent(formatValues(repositories.edges[0].node.forksCount));
        expect(getAllByTestId('stargazersCount')[0]).toHaveTextContent(formatValues(repositories.edges[0].node.stargazersCount));
        ...
        expect(getAllByTestId('forksCount')[1]).toHaveTextContent(formatValues(repositories.edges[1].node.forksCount));
        expect(getAllByTestId('stargazersCount')[1]).toHaveTextContent(formatValues(repositories.edges[1].node.stargazersCount));
